...
<div class="accordion accordion-flush" id="relatoriosEstatisticas">
    ...
    <?php
    /////////////////////////////////////////////////////////////////
    $query = "select count(*) as qt from agenda where data_agenda >= NOW() and colaborador = '{$_SESSION['ProjectPainel']->codigo}'";
    ...
    <?php
    /////////////////////////////////////////////////////////////////
    $query = "select count(*) as qt from agenda where situacao = 'c' and colaborador = '{$_SESSION['ProjectPainel']->codigo}'";
    $result = mysqli_query($con, $query);
    $d = mysqli_fetch_object($result);
    ?>
    <div class="accordion-item p-3">
    ...
    <?php
    /////////////////////////////////////////////////////////////////
    $query = "select count(*) as qt from agenda where situacao = 'n' and data_agenda < NOW() and colaborador = '{$_SESSION['ProjectPainel']->codigo}'";
    $result = mysqli_query($con, $query);
    $d = mysqli_fetch_object($result);
    ?>
    <div class="accordion-item p-3">
    ...
    <?php
    /////////////////////////////////////////////////////////////////
    $query = "select count(*) as qt, sum(valor) as valor from vendas where situacao = 'p' and colaborador = '{$_SESSION['ProjectPainel']->codigo}'";
    $result = mysqli_query($con, $query);
    $d = mysqli_fetch_object($result);
    ?>
    <div class="accordion-item p-3">
    ...
    <div class="accordion-item">
        ...
        $query = "select
                    ...
                    where c.situacao = 'p' and a.produto_tipo = 's'  and a.colaborador = '{$_SESSION['ProjectPainel']->codigo}' group by a.produto order by a.codigo desc";
        $result = mysqli_query($con, $query);
        ...
        <div class="accordion-body">
            ...
            $query = "select
                        ...
                        from vendas_produtos a
                            left join produtos b on a.produto = b.codigo
                            left join vendas c on a.venda = c.codigo
                        where c.situacao = 'p' and a.produto_tipo = 'p' and a.colaborador = '{$_SESSION['ProjectPainel']->codigo}' group by a.produto order by a.codigo desc";
            $result = mysqli_query($con, $query);
            $n = mysqli_num_rows($result);
            while($d = mysqli_fetch_object($result)){
            ?>
        ...
        <div class="accordion-body">
            ...
            $query = "select
                        ...
                        from vendas_produtos a
                            ...
                            left join vendas c on a.venda = c.codigo
                        where c.situacao = 'p' and a.colaborador = '{$_SESSION['ProjectPainel']->codigo}' group by a.colaborador order by a.codigo desc";
            $result = mysqli_query($con, $query);
            $n = mysqli_num_rows($result);
            while($d = mysqli_fetch_object($result)){
            ?>
    ...
    <?php
    /////////////////////////////////////////////////////////////////
    $query = "select count(*) as qt, sum(total) as valor from vendas where situacao = 'p' and colaborador = '{$_SESSION['ProjectPainel']->codigo}'";
    $result = mysqli_query($con, $query);
    $d = mysqli_fetch_object($result);
    ?>
    <div class="accordion-item p-3">
    ...
    <?php
    /////////////////////////////////////////////////////////////////
    $query = "select count(*) as qt, sum(comissao) as valor from vendas where situacao = 'p' and colaborador = '{$_SESSION['ProjectPainel']->codigo}'";
    $result = mysqli_query($con, $query);
    $d = mysqli_fetch_object($result);
    ?>
    <div class="accordion-item p-3">
